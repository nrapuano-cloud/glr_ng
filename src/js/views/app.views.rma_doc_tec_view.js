...
app.views.rma_doc_tec_view = Backbone.View.extend({
    
    initialize:function(){
    	console.log("initializing rma_doc_tec_view ")
    },
    events:{
    ...
    // breadcrumb: '<li><a class="breadcrumb-item active" href="'+e.target.href+'" >'+e.target.innerHTML+' / </a></li>'         
      ...
      app.routers.rmaRouter.prototype.rma_doc_tec_list();               //chiama la pagina data_type_edit
    ...
    destroy_view:function(){this.undelegateEvents();$(this.el).removeData().unbind();
        ...
        app.global.rma_doc_tec_viewView=null;
        app.global.nick_array.arr=null
    }
})//Backbone.View.extend({
return app.views.rma_doc_tec_view;
});
