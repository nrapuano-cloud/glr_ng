...
app.views.rma_doc_tec_new = Backbone.View.extend({
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if ($mydata.success){
                    ...
                    $aa=$mydata.data;
                    console.log($mydata.servizi,$servizio);
                    if($mydata.servizi){
                ...
                success: function(data){
                    ...
                    if(data=='invalid'){
                        ...
                        bootbox.alert({ 
                         ...
                         app.routers.rmaRouter.prototype.rma_doc_tec_new();
...
return app.views.rma_doc_tec_new;
    });
