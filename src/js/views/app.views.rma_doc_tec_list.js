...
app.views.rma_doc_tec_list = Backbone.View.extend({
    ...
    app.global.breadcrumb.push({
        ...
        app.routers.rmaRouter.prototype.archive_detail();               //chiama la pagina data_type_edit
...
var that = this;
   ...
   $.ajax({
    ...
    app.routers.rmaRouter.prototype.rma_doc_tec_detail();       
...
return app.views.rma_doc_tec_list;
    });
