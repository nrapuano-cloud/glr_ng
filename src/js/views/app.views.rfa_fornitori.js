...
app.views.rfa_fornitori = Backbone.View.extend({
       
    
    
    initialize:function(){
    console.log("initializing rfa_fornitori view");
     var jsonObj = {};
    ...
    addDdt:function (event) {
        console.log(app.global.nick_array.ordine);
        var modalF="";
        ...
        var $fornitore=app.global.nick_array.fornitore;
        that.$('.modal-title').empty();  
        that.$('.modal-title').text("Add DDT 7 all'ordine N° " + $num_prog + " per 7 " + $fornitore);  
    ...
    fetchFornitori: function () {//record selezionato nella tabella -- scelta servizio
        this.$('table tr:first th:eq( 1 )').text('P. Iva');
        this.$('table tr:first th:eq( 1 )').attr("data-field","piva"); //setter
        this.$('table tr:first th:eq( 2 )').text('Comune');
        this.$('table tr:first th:eq( 2 )').attr("data-field","comune"); //setter
        ...
        var getDdt =  this.fetchData(jsonObj, app.global.json_url + 'types/',this.headerJson());
    ...
    callList: function  (){
     ...
     hrTable: function  (my){
        ...
        $.each( my.data, function( key, value1 ){
            ...
            console.log(value1["data_approva"])
    ...
    //-----------------------------------------------------------------------------------
        ...
        this.$("#temp").change(function(){
           ...
           $(document).attr("title",app.global.app_short_name+" - "+app.global.app_long_name);
        return this},
    //----------------------------------------------------------------------------------------------------------------------
...
return app.views.rfa_fornitori;
    });
