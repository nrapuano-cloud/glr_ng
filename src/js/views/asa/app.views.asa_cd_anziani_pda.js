require(['app','bootbox'], function(app,bootbox){
    app.views.asa_cd_anziani_pda = Backbone.View.extend({
        initialize: function () {
            console.log("initializing asa pda ");
        ...
        addRow:function (that) {
            ...
            $("#modal").modal('show');
            $('.modal-title').text("Add Piano delle attività");
            //qui
        ...
        switch (that.item) {
            case "pda":{// piano delle attivita
                that.$("#boot").empty();
                varForm='<h3> Piano delle attività <span class="badge">'+my.data.length+' </span></h3><br>'+
            ...
            window.actionEvents = {
                ...
                'click .edit': function (e, value, row,index) {
                    ...
                    $(".modal-body").append(        
                        ...
                        '<div  class="form-group col-lg-12 alle">'+
                            '<div class="form-group col-lg-6">'+
                                ...
                                '<div class="input-group date " id="datetimepicker1">'+
                                    ...
                                    '<input type="text" class="form-control "  id="dataTemp" name="dataTemp" value="'+ (row.data_doc).substring(3)+'"/>'+ 
                                    '<span class="input-group-addon">'+  
                                        '<span class="glyphicon glyphicon-calendar"></span>'+ 
                                '</span>'+
                                '</div>'+
                        ...
                        '</div>'+ 
                        '<button type="button" id="btnAlle" name="btnAlle" class="btn btn-primary submit ">Update</button>'+
                        '</form >'
                    );
                    $('#datetimepicker1').datetimepicker({ 
                        format: "mm/yyyy",
                    ...
                    $("#modal").modal('show');
                    $('.modal-title').text("Update Piano delle attività");
                    //qui
                    ...
                    $('#btnAlle').click(function(e) {
                        if($("#modContratto").valid()){
                            ...
                            form_data.append('tipo', row.tipo);
                            form_data.append('sub_area', app.global.sub);
        ...
        destroy_view: function () {
            ...
            app.global.asa_cd_anziani_pdaView=null
        }
    });
return app.views.asa_cd_anziani_pda;
});