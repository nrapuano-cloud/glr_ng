...
app.views.rma_doc_tec_detail = Backbone.View.extend({
    ...
    app.global.breadcrumb.push({
      ...
      app.routers.rmaRouter.prototype.rma_doc_tec_detail();               //chiama la pagina data_type_edit
...
var that = this;
   ...
   $.ajax({
    ...
    return  app.views.rma_doc_tec_detail;
    });
