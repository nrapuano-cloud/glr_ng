...
app.views.rfa_vad = Backbone.View.extend({//visualizza acquisto diretto
       
    initialize:function(){
     	console.log("initializing rfa_vad view");
        var jsonObj = {};
          var that = this;  
    ...
    hrTable: function  (my){
        ...
        $.each( my.data, function( key, value1 ){
            ...
            if(typeof(value1["data_acquisto"]) !== "undefined" && value1["data_acquisto"] !== null){   
                value1["dateT"]='<span>'+moment(value1["data_acquisto"]).format('YYYYMMDD')+'</span>'+moment(value1["data_acquisto"]).format('DD/MM/YYYY');
    ...
    render:function(){
        ...
        window.actionEvents = {
            'click .downloadDoc': function ($element, value, row,index) {
                ...
                var jsonObj = {};
                jsonObj.person = app.global.tokensCollection.first().get("id_person");
                jsonObj.type ="ad";//acquisto diretto
            ...
            'click .remove': function (e, value, row,index) {
                ...
                if (confirm('Sei sicuro di voler eliminare questo Acquisto Diretto?')) {
                    jsonObj = {};
                    jsonObj.action = "del";
                    jsonObj.type = "ad";
                    jsonObj.id=row.id;
                    ...
                    $.ajax({
                        ...
                        error: function () {
                            ...
                            console.log("Delete Acquisto Diretto error!");
                        }
                    });
